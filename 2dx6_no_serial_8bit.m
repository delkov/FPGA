...
out=[1 21 1000 10000,...
     ...
     3 333 3000 30000,...
          3 333 3000 30000,...
     3 333 3000 30000,...     3 333 3000 30000,...
     3 333 3000 30000,...
     3 333 3000 30000,...
          3 333 3000 30000,...
     3 333 3000 30000,...
...
%     M_3=uint8(M_3);
    ...
    while j<20000
      % cla(ha(1))%    axes(ha(1));
    % set(pl(1),'CData',uint8(M));
    % set(pl(2),'CData',uint8(M_2));
    % set(pl(3),'CData',uint8(M_3));
...
function TOF_AR = TOF(A)%,CLK_PERIOD,CALIB_PERIODS)
    % try
        ...
        for i=1:1:size_B
            TOF_AR(i)=  0.02*A(4*(i-1)+2) / ( A(4*(i-1)+4)-A(4*(i-1)+3) ); % time offset & 0.15m
